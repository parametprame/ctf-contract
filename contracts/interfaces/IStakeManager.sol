...
interface IStakeManager is IERC165 {
     ...
     */
    function unauthorizeHubByOwner(
        address relayManager,
        address relayHub
    ) external;
    ...
    function getStakeInfo(
        ...
        external
        view
        returns (StakeInfo memory stakeInfo, bool isSenderAuthorizedHub);
     ...
     */
    function getAbandonedRelayServerConfig()
        external
        view
        returns (AbandonedRelayServerConfig memory);
